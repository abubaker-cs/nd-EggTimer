...
private val FLAGS =
    FLAG_ONE_SHOT // the flag value of #FLAG_ONE_SHOTsince the intent will be used only once.
...
fun NotificationManager.sendNotification(messageBody: String, applicationContext: Context) {
    ...
    ).setOnlyAlertOnce(true) // Only the first time the notification appears
